...
public class TestJOptionPane
{
	...
	private String messageString = "消息内容区";
	...
	public void init()
		...
		messagePanel = new ButtonPanel("选择消息区内容的类型", 
		...
		//创建用于弹出选项对话框的Panel
		optionsPanel = new ButtonPanel("选择对话框", 
	...
	private class ShowAction implements ActionListener
	{
		...
		{  
			...
			{  
				...
				{
					JOptionPane.showInputDialog(jf, getMessage(), "输入对话框", getDialogType(),
					null,	new String[] {"J2EE企业应用", "Struts2权威指南"}, 
					"Struts2È权威指南");
				}
			}
...
//定义一个JPanel类扩展类，该类的对象包含多个纵向排列的JRadioButton
//且Panel扩展类可以指定一个字符串作为TitleBorder
